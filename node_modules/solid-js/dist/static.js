...
function createResource(key, fetcher, value) {
  ...
  function load() {
    ...
    resourceContext = [];
    const lookup = typeof key === "function" ? key() : key;
    if (resourceContext.length) {
      p = Promise.all(resourceContext).then(() => fetcher(key(), () => value));
    }
  ...
  return new Promise(resolve => {
    ...
    function getCallback(key) {
      ...
      return value => {
        ...
        registry.delete(key);
        if (!registry.size) queueMicrotask(() => {
