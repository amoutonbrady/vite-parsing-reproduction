...
const MetaProvider = props => {
  ...
  const actions = {
    ...
    shouldRenderTag: (tag, index) => {
      if (cascadingTags.indexOf(tag) !== -1) {
        const names = state[tag]; // check if the tag is the last one of similar
...
const MetaTag = props => {
  ...
  return _$createComponent(Show, {
    get when() {
      return shouldRenderTag(internal.tag, index);
    },
...
export const Title = props => MetaTag(mergeProps({
  tag: "title"
}, props));
export const Style = props => MetaTag(mergeProps({
  tag: "style"
}, props));
export const Meta = props => MetaTag(mergeProps({
  tag: "meta"
}, props));
export const Link = props => MetaTag(mergeProps({
  tag: "link"
}, props));
export const Base = props => MetaTag(mergeProps({
  tag: "base"
}, props));
